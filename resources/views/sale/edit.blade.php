                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="sale_number" name="sale_number" placeholder="Sale Number" required value="{{$sale->sale_no}}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="sale_title">Sale Title</label>
                                <input type="text" class="form-control" id="sale_title" name="sale_title" placeholder="Sale Title" value="Sale Title">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="sale_date">Date</label>
                                <input type="date" class="form-control" id="sale_date" name="sale_date" placeholder="Sale Date" value="{{ $sale->created_at }}" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <table class="table" id="sale_product_table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <input type="hidden" name="item_number[]" value="{{$item->item_no}}">
                                        <td>{{$item->item_no}}</td>
                                        <td>""</td>
                                        <td>${description}</td>
                                        <td>${unit}</td>
